...
public class GeneralInfoEntity {
    ...
    private StructureInfoEntity structureInfoEntity;
    ...
    private List<DetailInfoEntity> detailInfos = new ArrayList<>();

    @OneToMany(mappedBy = "generalInfoEntity", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<SupportStaffEntity> supportStaffEntity = new ArrayList<>();
    ...
    @OneToMany(mappedBy = "generalInfoEntity", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<ReceptorEntity> receptorEntity = new ArrayList<>();
